				...
				children: [
					Expanded(
						child: Column(
				            ...
				            Text('CREATOR', style: GoogleFonts.poppins(
						                	textStyle: TextStyle(
						                	fontSize: 30,
						                	color: Colors.white,
				             ...
				             Text('COFFEE GRADE DETECTOR', style: GoogleFonts.poppins(
						                	textStyle: TextStyle(
						                	fontSize: 15,
					...
					Container(
						...
						child: Column(
							...
							children: [
								...
								SizedBox(height: 10),
								ElevatedButton(
									child: Text('Mulai Pengukuran', style: TextStyle(color: Color(0xFF601E06))),
									style: ElevatedButton.styleFrom(
										shape: StadiumBorder(),
